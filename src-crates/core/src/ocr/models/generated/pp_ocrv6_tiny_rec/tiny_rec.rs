// Generated from ONNX "/tmp/opencode-build/akuna-ocr-paddle-codegen/patched/tiny_rec.onnx" by burn-onnx
...
impl<B: Backend> Submodule1<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let batchnormalization1 = BatchNormConfig::new(24)
            ...
            .init(device);
        let constant6: burn::module::Param<Tensor<B, 1>> =
        ...
        let constant7: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant8: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let conv2d3 = Conv2dConfig::new([48, 48], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant15: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d4 = Conv2dConfig::new([48, 12], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant17: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d5 = Conv2dConfig::new([12, 48], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant19: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d6 = Conv2dConfig::new([48, 96], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant21: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let constant22: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant23: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant24: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let conv2d7 = Conv2dConfig::new([96, 48], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant26: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d8 = Conv2dConfig::new([48, 48], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant28: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d9 = Conv2dConfig::new([48, 96], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant30: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let constant31: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant32: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant33: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let conv2d10 = Conv2dConfig::new([96, 48], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant35: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d11 = Conv2dConfig::new([48, 48], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant37: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d12 = Conv2dConfig::new([48, 96], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant39: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
    ...
    pub fn forward(&self, x: Tensor<B, 4>) -> Tensor<B, 4> {
        ...
        let batchnormalization1_out1 =
            self.batchnormalization1.forward(conv2d1_out1);
        ...
        let batchnormalization2_out1 =
            self.batchnormalization2.forward(conv2d2_out1);
        ...
        let reducemean1_out1 =
            { add2_out1.clone().mean_dim(2usize).mean_dim(3usize) };
...
impl<B: Backend> Submodule2<B> {
    #[allow(unused_variables)]
    pub fn new(device: &B::Device) -> Self {
        let constant40: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant41: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant42: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let conv2d13 = Conv2dConfig::new([96, 96], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant44: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d14 = Conv2dConfig::new([96, 96], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant46: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d15 = Conv2dConfig::new([96, 24], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant48: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d16 = Conv2dConfig::new([24, 96], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant50: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d17 = Conv2dConfig::new([96, 192], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant52: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let constant53: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant54: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant55: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let conv2d18 = Conv2dConfig::new([192, 96], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant57: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d19 = Conv2dConfig::new([96, 96], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant59: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d20 = Conv2dConfig::new([96, 192], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant61: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let constant62: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant63: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant64: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let conv2d21 = Conv2dConfig::new([192, 96], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant66: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d22 = Conv2dConfig::new([96, 96], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant68: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d23 = Conv2dConfig::new([96, 192], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant70: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let constant71: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
    ...
    pub fn forward(&self, add15_out1: Tensor<B, 4>) -> Tensor<B, 4> {
        ...
        let reducemean2_out1 =
            { add18_out1.clone().mean_dim(2usize).mean_dim(3usize) };
...
impl<B: Backend> Submodule3<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let conv2d24 = Conv2dConfig::new([192, 160], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant75: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d25 = Conv2dConfig::new([160, 160], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant77: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d26 = Conv2dConfig::new([160, 40], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant79: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d27 = Conv2dConfig::new([40, 160], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant81: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d28 = Conv2dConfig::new([160, 320], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant83: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let constant84: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant85: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let constant86: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let conv2d29 = Conv2dConfig::new([320, 160], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant88: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d30 = Conv2dConfig::new([160, 160], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant90: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d31 = Conv2dConfig::new([160, 320], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant92: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let constant93: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let conv2d32 = Conv2dConfig::new([320, 160], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant97: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d33 = Conv2dConfig::new([160, 160], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant99: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let conv2d34 = Conv2dConfig::new([160, 320], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant101: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
        ...
        let constant102: burn::module::Param<Tensor<B, 1>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 1>::from_data(
        ...
        let conv2d35 = Conv2dConfig::new([320, 160], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant106: burn::module::Param<Tensor<B, 4>> =
            burn::module::Param::uninitialized(
                burn::module::ParamId::new(),
                move |device, _require_grad| {
                    Tensor::<B, 4>::zeros(
    ...
    pub fn forward(&self, mul15_out1: Tensor<B, 4>) -> Tensor<B, 3> {
        ...
        let reducemean3_out1 =
            { add34_out1.clone().mean_dim(2usize).mean_dim(3usize) };
        ...
        let unsqueeze1_out1: Tensor<B, 4> =
            transpose2_out1.unsqueeze_dims::<4>(&[2]);
        ...
        let batchnormalization3_out1 =
            self.batchnormalization3.forward(squeeze2_out1);
        ...
        let unsqueeze2_out1: Tensor<B, 4> =
            mul24_out1.unsqueeze_dims::<4>(&[2]);
        let conv2d37_out1 = self.conv2d37.forward(unsqueeze2_out1);
        let squeeze3_out1 = conv2d37_out1.squeeze_dims::<3>(&[2]);
        let batchnormalization4_out1 =
            self.batchnormalization4.forward(squeeze3_out1);
