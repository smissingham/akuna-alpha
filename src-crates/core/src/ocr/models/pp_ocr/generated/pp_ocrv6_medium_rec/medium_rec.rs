...
// Generated from ONNX "/var/folders/r8/v0v7bpr93jn7636n86zxwn0r0000gn/T/nix-shell.kwhRLa/akuna-pp-ocr-codegen/patched/medium_rec.onnx" by burn-onnx
use burn::prelude::*;
...
impl<B: Backend> Submodule1<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant4: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 32, 1, 1], device),
            device.clone(),
            false,
            [1, 32, 1, 1].into(),
        );
        ...
        let constant10: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 128, 1, 1], device),
            device.clone(),
            false,
            [1, 128, 1, 1].into(),
        );
        ...
        let constant18: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 256, 1, 1], device),
            device.clone(),
            false,
            [1, 256, 1, 1].into(),
        );
...
impl<B: Backend> Submodule2<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant36: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 512, 1, 1], device),
            device.clone(),
            false,
            [1, 512, 1, 1].into(),
        );
        ...
        let conv2d19 = Conv2dConfig::new([64, 256], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant47: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 256, 1, 1], device),
            device.clone(),
            false,
        ...
        let conv2d20 = Conv2dConfig::new([256, 512], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant49: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 512, 1, 1], device),
            device.clone(),
            false,
    ...
    pub fn forward(&self, mul5_out1: Tensor<B, 4>) -> Tensor<B, 4> {
        ...
        let reducemean2_out1 = { add22_out1.clone().mean_dim(2usize).mean_dim(3usize) };
...
impl<B: Backend> Submodule3<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let conv2d27 = Conv2dConfig::new([128, 512], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant69: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 512, 1, 1], device),
            device.clone(),
            false,
        ...
        let conv2d28 = Conv2dConfig::new([512, 1024], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant71: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 1024, 1, 1], device),
            device.clone(),
            false,
            [1, 1024, 1, 1].into(),
        );
        ...
        let conv2d35 = Conv2dConfig::new([128, 512], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant91: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 512, 1, 1], device),
            device.clone(),
            false,
    ...
    pub fn forward(&self, conv2d24_out1: Tensor<B, 4>) -> Tensor<B, 4> {
        ...
        let reducemean3_out1 = { add33_out1.clone().mean_dim(2usize).mean_dim(3usize) };
        ...
        let reducemean4_out1 = { add45_out1.clone().mean_dim(2usize).mean_dim(3usize) };
...
impl<B: Backend> Submodule4<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let conv2d43 = Conv2dConfig::new([128, 512], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant113: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 512, 1, 1], device),
            device.clone(),
            false,
    ...
    pub fn forward(&self, add51_out1: Tensor<B, 4>) -> Tensor<B, 4> {
        ...
        let reducemean5_out1 = { add57_out1.clone().mean_dim(2usize).mean_dim(3usize) };
...
impl<B: Backend> Submodule5<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let conv2d55 = Conv2dConfig::new([768, 1536], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant146: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 1536, 1, 1], device),
            device.clone(),
            false,
            [1, 1536, 1, 1].into(),
        );
        ...
        let conv2d56 = Conv2dConfig::new([1536, 768], [1, 1])
            ...
            .with_bias(false)
            .init(device);
        let constant151: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 768, 1, 1], device),
            device.clone(),
            false,
        ...
        let conv2d57 = Conv2dConfig::new([768, 768], [3, 3])
            ...
            .with_bias(false)
            .init(device);
        let constant153: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 4>::zeros([1, 768, 1, 1], device),
            device.clone(),
            false,
    ...
    pub fn forward(&self, add68_out1: Tensor<B, 4>) -> Tensor<B, 4> {
        ...
        let reducemean6_out1 = { add73_out1.clone().mean_dim(2usize).mean_dim(3usize) };
...
impl<B: Backend> Submodule6<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant186: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 1>::zeros([192], device),
            device.clone(),
            false,
            [192].into(),
        );
    ...
    pub fn forward(
        &self,
        averagepool2d1_out1: Tensor<B, 4>,
    ) -> (Tensor<B, 3>, i64, Tensor<B, 4>) {
        let conv2d60_out1 = self.conv2d60.forward(averagepool2d1_out1.clone());
        let batchnormalization1_out1 = self.batchnormalization1.forward(conv2d60_out1);
        ...
        let batchnormalization2_out1 = self.batchnormalization2.forward(conv2d61_out1);
        ...
        let batchnormalization3_out1 = self.batchnormalization3.forward(conv2d62_out1);
        ...
        let shape1_out1: [i64; 4] = {
            let axes = &add85_out1.clone().dims()[0..4];
        ...
        let constant183_out1: [i64; 1] = [-1i64];
        let concat2_out1: [i64; 3usize] = [&slice2_out1[..], &constant183_out1[..]]
            .concat()
            .try_into()
            .unwrap();
        let reshape1_out1 = add85_out1.reshape(concat2_out1);
        ...
        (add91_out1, squeeze1_out1, mul35_out1)
    }
}
#[derive(Module, Debug)]
...
impl<B: Backend> Submodule7<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant238: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 1>::from_data([2f64], device),
            device.clone(),
            false,
        ...
        let constant239: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                1,
        ...
        let constant240: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 1>::zeros([192], device),
            device.clone(),
            false,
        ...
        let constant241: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<B, 1>::zeros([192], device),
            device.clone(),
            false,
        ...
        let linear9 = LinearConfig::new(192, 18710).with_bias(true).init(device);
        Self {
            constant215,
            constant216,
            constant217,
    ...
    pub fn forward(
        &self,
        add91_out1: Tensor<B, 3>,
        squeeze1_out1: i64,
        mul35_out1: Tensor<B, 4>,
    ) -> Tensor<B, 3> {
        ...
        let constant250_out1: [i64; 1] = [0i64];
        let constant251_out1: [i64; 1] = [1i64];
        let constant252_out1: [i64; 1] = [192i64];
        let concat3_out1: [i64; 4usize] = [
            ...
            .try_into()
            .unwrap();
        let reshape8_out1 = add99_out1.reshape(concat3_out1);
...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file(
            "/var/folders/r8/v0v7bpr93jn7636n86zxwn0r0000gn/T/nix-shell.kwhRLa/akuna-pp-ocr-codegen/burn/medium_rec/medium_rec.bpk",
            &Default::default(),
        )
    }
}
...
impl<B: Backend> Model<B> {
    ...
    pub fn forward(&self, x: Tensor<B, 4>) -> Tensor<B, 3> {
        ...
        let (add91_out1, squeeze1_out1, mul35_out1) = self
            .submodule6
            .forward(averagepool2d1_out1);
        let softmax3_out1 = self
            .submodule7
            .forward(add91_out1, squeeze1_out1, mul35_out1);
        softmax3_out1
    }
}
