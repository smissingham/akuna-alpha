// Generated from ONNX "/tmp/opencode-build/akuna-ocr-paddle-codegen/patched/small_det.onnx" by burn-onnx
...
impl<B: Backend> Submodule2<B> {
    ...
    pub fn forward(
        ...
        let globalaveragepool1_out1 =
            self.globalaveragepool1.forward(conv2d55_out1.clone());
        ...
        let globalaveragepool2_out1 =
            self.globalaveragepool2.forward(conv2d58_out1.clone());
        ...
        let globalaveragepool3_out1 =
            self.globalaveragepool3.forward(conv2d61_out1.clone());
        ...
        let globalaveragepool4_out1 =
            self.globalaveragepool4.forward(conv2d64_out1.clone());
        ...
        let globalaveragepool5_out1 =
            self.globalaveragepool5.forward(conv2d68_out1.clone());
        ...
        let globalaveragepool6_out1 =
            self.globalaveragepool6.forward(conv2d72_out1.clone());
        ...
        let globalaveragepool7_out1 =
            self.globalaveragepool7.forward(conv2d76_out1.clone());
        ...
        let globalaveragepool8_out1 =
            self.globalaveragepool8.forward(conv2d80_out1.clone());
