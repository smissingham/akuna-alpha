...
use burn::tensor::{
    activation::softmax, backend::Backend, module::conv1d, ops::ConvOptions,
    Tensor, TensorData,
};
...
use crate::detection::{
    config::{runtime_config, ModelConfig},
    models::magika_preprocess::{prepare_input, PreparedInput},
...
const LAYER_NORM_0_WEIGHT: TensorSpec = TensorSpec {
    name:
        "jax2tf_get_logits_/pjit_get_logits_/MagikaV2/LayerNorm_0/Reshape_2:0",
...
const LAYER_NORM_0_BIAS: TensorSpec = TensorSpec {
    name:
        "jax2tf_get_logits_/pjit_get_logits_/MagikaV2/LayerNorm_0/Reshape_3:0",
    shape: &[1, TOKENS_PER_BLOCK, 1, 0],
    rank: 3,
};
...
const LAYER_NORM_1_WEIGHT: TensorSpec = TensorSpec {
    name:
        "jax2tf_get_logits_/pjit_get_logits_/MagikaV2/LayerNorm_1/Reshape_2:0",
...
const LAYER_NORM_1_BIAS: TensorSpec = TensorSpec {
    name:
        "jax2tf_get_logits_/pjit_get_logits_/MagikaV2/LayerNorm_1/Reshape_3:0",
    shape: &[1, CONV_OUT_CHANNELS, 0, 0],
    rank: 2,
};
