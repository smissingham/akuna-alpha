...
use crate::{ExtractionMetadata, FileExtractionError, TextExtractionConfig};
...
impl From<akuna_core_detection::MagikaInferenceError> for FileExtractionError {
    fn from(source: akuna_core_detection::MagikaInferenceError) -> Self {
